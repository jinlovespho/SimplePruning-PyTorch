...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, mode='train'):
        ...
        self.shortcut = (not self.equalInOut) and Shortcut(in_planes, planes, self.expansion, kernel_size=1,
                                                           stride=stride, bias=False) or None
